...
get_multiple_years <- function(
    ...
    my_tibble <- as.tibble(lapply(years, function (y) get_single_year(y,num_vars, cat_vars, geography, geography_level))) |> mutate(Year = years)
...
summary.census <- function(my_tibble, num_vars = NULL, cat_vars = NULL)
{
