...
get_single_year <- function(
        ...
        cat_vars = c("SEX"), geography = "All", geography_level = c(":*"))
    {
...
get_multiple_years <- function(
    ...
    multi_year_tibble <- as.tibble(lapply(years, function (y) get_single_year(y,num_vars, cat_vars, geography, geography_level))) |> mutate(Year = years)
...
class(multi_year_tibble) <- c("census", class(multi_year_tibble))
